...
(function(window,undefined){
    ...
    window.Per = function(el){
                                ...
                                set: function(newVal){
                                    ...
                                    for(var i=0,len = Element.length;i<len;i++){
                                        ...
                                        if(Element[i].getAttribute("p-for-in") != null){
                                            var perForObj = new Object();
                                            perForObj[Element[i].getAttribute("p-for-in")] = forInnerHTML;
                                            Per(Obj.el).do({
                                                data: perForObj
                                            });
                                        }else{
        ...
        this.getAllModuleNameAndVersion = function(){
    ...
    per.joinModule("Per.page",allVersion,function(){
        ...
        window.Per.prototype.page = function(){
            return {
                create: {
    ...
    per.joinModule("Per.check",allVersion,function(){
        window.Per.prototype.check = function(){
            return {
    ...
    per.joinModule("Per.lazyLoad",allVersion,function(){
        ...
        window.Per.prototype.lazyLoad = function(){
            return {
    ...
    per.joinModule("Per.browser",allVersion, function(){
        window.Per.prototype.browser = function(){
            return {
                type: function(){
